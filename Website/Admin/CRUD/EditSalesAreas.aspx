...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="row">
        <div class="col-md-6">
            <h1>Regions</h1>
            <asp:ListView ID="RegionListView" runat="server" DataSourceID="RegionsDataSource" InsertItemPosition="LastItem" DataKeyNames="RegionID">
    ...
    <asp:ObjectDataSource runat="server" ID="RegionsDataSource" DataObjectTypeName="NorthwindTraders.Entities.Region" DeleteMethod="DeleteRegion" InsertMethod="AddRegion" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAllRegions" TypeName="NorthwindTraders.BLL.CRUD.RegionController" UpdateMethod="UpdateRegion"
        OnDeleted="CheckForException" OnInserted="CheckForException" OnUpdated="CheckForException"></asp:ObjectDataSource>
</div>
        <div class="col-md-6">
            <h1>Territories</h1>
                <asp:ListView ID="TerritoryListView" runat="server" DataSourceID="TerritoriesDataSource" DataKeyNames="TerritoryID" ItemType="NorthwindTraders.Entities.Territory" InsertItemPosition="LastItem">
                    <LayoutTemplate>
                    ...
                    <ItemTemplate>
                        <div>
                            <asp:Label ID="TerrirotryDescriptionLabel" runat="server" Text='<%# Item.TerritoryDescription + " (" + Item.Region.RegionDescription +")" %>' />
                        </div>
                    </ItemTemplate>
